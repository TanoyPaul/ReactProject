...
function Card(props) {
  ...
  <div class="p-4">
    ...
    <p class="mt-3 text-sm text-gray-600">
      {props.username} ipsum dolor sit amet consectetur adipisicing elit. Excepturi,
      debitis?
    </p>
    <button
      type="button"
    ...
    >
      {props.btn || "hey"} 
       {/* In case of user don't pass any value of btn in the component "Card", "hey" will be it's default value  */}
    </button>
  </div>
</div>
    </>
